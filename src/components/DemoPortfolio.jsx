...
export const DemoPortfolio = ({ 
  ...
  subtitle = "These purpose-built concept demonstrations show how Wisdom Designs creates fast, conversion-focused websites tailored for specific business industries."
}) => {
